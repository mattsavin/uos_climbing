    ...
    walls: [
        {
            ...
            description:
                "The UK's first dedicated climbing wall and a Sheffield legend. Great for both ropes and bouldering.",
        ...
        },
        {
            ...
            type: 'Bouldering',
            description:
                'Huge modern bouldering gym with hundreds of problems for all levels. Host to many national comps.',
        ...
        },
        {
            ...
            type: 'Leading / Speed',
            description:
                'Home to incredible lead walls and a dedicated speed climbing lane. Perfect for endurance training.',
